...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, args):
        ...
        ###################################################################
        # Please fill the codes below with the *self._make_layer()* function
        ##################################################################
        ...
        ###################################################################
        # Please substitute the "?" with specific numbers
        ##################################################################
        # change ResNet to suit the detection requirement
        yolo_S, yolo_B, yolo_C = args.yolo_S, args.yolo_B, args.yolo_C

        self.det_head = self._make_detection_head(in_channels=2048, out_channels=5*yolo_B+yolo_C)  # 5*B+C
        ##################################################################
